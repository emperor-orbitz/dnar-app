...
function Event(props: any): ReactElement {
    return (
        <div className='event-card' style={{ backgroundImage: `url(${props.screenshot})`}}>
            <div style={{ background: '#17151d', borderRadius: '5px', position: 'absolute', bottom: '0', padding: '10px', height: '70%', boxShadow: '3px 3px 102px -2px rgba(11,8,8,0.56)', color: 'white', }}>
                <h5>{props.title}</h5>
